<?php defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 class mensajemodel extends CI_Model {
    ...
    function registramensajetw($hora_inicio_msj , $hora_termino_msj, $mensaje , $lunes , $martes, $miercoles , $jueves , $viernes, $sabado, $domingo, $campid ){

             $data = array(            
                'descripcion' => $mensaje ,
                 'idcampaña' => $campid  ,                  
                 'social' => "T" ,                       
                 'horainicio' => $hora_inicio_msj , 
                 'horatermino' => $hora_termino_msj , 
                 'L' => $lunes , 
                 'M' => $martes , 
                 'MI' => $miercoles , 
                 'J' => $jueves , 
