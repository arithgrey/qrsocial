...
<div class='row'>
	<div class="row medium-uncollapse large-collapse"> 
		...
		<fieldset>
			...
			<div class='row'>
				<div id="return_camp" class="large-2 columns alert-box">
					<?=img('application/img/general/leftarrow8.png')?>
				</div>
				<div id='main_s'>
					<p class='detalle_zona large-5 columns alert-box'><?=img('application/img/general/configure.png')?> Mensaje  #<?=$mensaje;?></p>
				</div>
				<div id='more_s'>
					<p class='detalle_zona large-5 columns alert-box'><?=img('application/img/general/add182.png')?> Más detalles</p>
				</div>
			</div>
