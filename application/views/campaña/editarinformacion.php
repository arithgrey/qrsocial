	...
	<fieldset>
		<div class='row'>
	    			...
	    			<a href="<?=base_url('index.php/cuentas/accessacount')?>">
	    				<p class='large-2 columns detalle_zona alert-box'>	    					
	    					<img width="33%" src="<?=base_url('application/img/general/leftarrow8.png')?>">
	    				</p>
	    			</a>
		<p id='general_s' class='large-3 columns detalle_campaña alert-box'>			
			<img width="20%" src="<?=base_url('application/img/general/configure.png')?>">
			Campaña #<?=$campid;?>
		</p>
		<p id='zonas_s' class='large-4 columns detalle_campaña alert-box'>			
			<img  width="14%" src="<?=base_url('application/img/general/map49.png')?>">
			Zonas anexadas</p>
		
		<p id="mensajes_section" class='large-3 columns detalle_campaña alert-box'>			
			<img  width="20%" src="<?=base_url('application/img/general/clock118.png')?>">
			Mensajes
		</p>
