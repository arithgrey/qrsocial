...
<style type="text/css">
  ...
  <div class="row">
          ...
          <a href="<?=base_url('index.php/cuentas/accessacount')?>">
            <div class=''>              
                <?=img('application/img/general/leftarrow8.png')?>                                          
            </div>
        </a>
  </div>      
        ...
        <div class='row alert-box'>
          <div class="row" >                    
            ...
            <div class="large-8 columns">
              ...
              <label id='descripcionsection' class='descripcionsection large-12 columns'></label> 
            </div>  
            <div onclick="navmenucampania('primeros_pasos');" class='large-4 columns'>
            ...
            <div onclick="navmenucampania('mensajes_facebook');" class='large-6 columns detalle_zona'>
            ...
            <div onclick="navmenucampania('mensaje_twitter');"  class='large-6 columns detalle_zona' id="">
  ...
  <fieldset class="row">
         <form name="mensajefbform" id="mensajefbform">    
            <input type="hidden" name="campid" id='campid' value="<?=$campid?>">
                      ...
                      <fieldset>
                        <div class="large-6 columns">
                          <label id='lb_description'>Mensaje para Facebook</label>
                        </div>
                        <div class="large-6 columns">
                          <textarea rows="4" cols="50" name='descripcion' class='descripcion large-12 columns' id='descripcion'>                  
                                          ...
                                          <input type="hidden" name="mensajefbn" id="mensajefbn">                                                       
                      ...
                      <fieldset>
                        <div class="large-6 columns">
                          <div class='large-12 columns'>
                            <label id='lb_description'>Horarios en que el mensaje estará disponible</label>     
                            <div id='horariosdisponibleshoras'></div>                              
                          </div>
                        </div>

                        <div class="large-6 columns">                          
                                  <label id='lb_description'>Días disponible</label>                          
                                    ...
                                    <div id="reporte_acc" class="alert-box secondary large-12 columns"><p id="p_repotemporal"></p></div>
                                  <button class="large-12 columns" id="registrointemporalbtn">Registrar publicación  <?=img('application/img/general/thumb12.png')?> </button>                                                
...
<fieldset class="row">
  ...
  <form id="mensaje_twitter" name="mensaje_twitter"  >
        ...
        <div class='large-5 columns'>                                                  
          ...
          <button id="registromsjtwitter">Registrar publicación <?=img('application/img/general/twitter35.png')?></button>                                          
        </div>
