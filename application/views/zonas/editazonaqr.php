...
<div id='section_general'>
		...
		<fieldset>
			<div class="small-6 columns"> <label id='lb_description'><img src="<?=base_url('application/img/tipo_zonas/black218.png')?>">Mensaje que pararecerá por default en esta zona</label> </div>
