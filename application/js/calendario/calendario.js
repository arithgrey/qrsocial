...
function asignarhoramensaje(e){
	...
	slect ="<p id='titlehora'>Hora en que iniciará a estar disponible el mensaje</p><select name='hora_inicio_select' id='hora_inicio_select' ><option value = '"+horainicio+"'> "+hora+" <option></select>";

		nlect = "<p id='titlehora'>Hora en que dejara de estar disponible el mensaje</p> <select name='hora_termino_select' id='hora_termino_select' >";	
		for (var a = 0; a <= 23; a++) {
