...
function loadzonas(){
    ...
    $.get(url).done(function(data){        
        ...
        e="<table class='large-12 columns' ><tr id='title_table' class='title_table'><td> <label class='titulo_mensaje'>qr<label></td>";
        ...
        for (var a = 0; a < data.length; a++) {            
            ...
            urlmensajedef = data[a].urlmensajedef;
                ...
                e+="<tr>";
                e+="<td><img style='width: 33%;' src= '"+imgurl+"' id='imgqrsocial' ></td>";
          //      e+="<td>"+urlmensajedef+"</td>";
                e+="<td>"+ data[a].zonanombre + "</td>";            
                url_img_tipo=$(".now").val()+ "application/img/tipo_zonas/"+data[a].img_name; 
                e+="<td><div> <img style='width: 25%;' src='"+url_img_tipo+"'><label>"+data[a].nombre +"</label></div> </td>";
