...
function loadcamp(){
    ...
    $.get(url).done(function(data){
        ...
        listado="<table class='large-12 columns'><tr class='title_table' id='title_table'><td><label class='titulo_mensaje'>#</label></td><td><label class='titulo_mensaje'>Campaña de Marketing</label></td><td><label class='titulo_mensaje'>Mensajes para redes sociales</label></td><td><label class='titulo_mensaje'>Configuración</label></td><td><label class='titulo_mensaje'>Eliminar</label></td></tr>";
                            ...
                            for (var a = 0; a < data.length; a++) {                                 
                                ...
                                listado +="<tr><td>"+idcampaña+"</td> <td><a id='ref_camp' href='"+direct+"'> "+nombre+"</a></td>"+
                                          //"<td>"+descripcion.slice(0 , 150)+"<a class='seguir_leyendo' id='"+idcampaña+"'> ...leer</a></td>"+
                                          //"<td>"+descripcion.slice(0 , 150)+"....</td>"+                                        
                                          "<td><a href='"+direct+"'>"+ "<img style='width: 12%;' src='"+imgpath+"'></td>" +"</a>"+                                        
