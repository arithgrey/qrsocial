...
function loadcamp(){
    ...
    $.get(url).done(function(data){
        ...
        listado="<table class='large-12 columns'><tr class='title_table' id='title_table'><td><label class='titulo_mensaje'>#</label></td><td><label class='titulo_mensaje'>Campaña de Marketing</label></td><td><label class='titulo_mensaje'>Mensajes y detalles</label></td><td><label class='titulo_mensaje'>Configuración</label></td><td><label class='titulo_mensaje'>Eliminar</label></td></tr>";
