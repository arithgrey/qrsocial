    ...
    $.get(url, {"idcampania": idcampania}).done(function(data){
    	...
    	for (var i = 0; i < data.length; i++) {
                ...
                if (data[i].iszonacamp >0 ) {
                    ...
                    texto=" Quitar zona de la campaña  ";         
                }else{
                    imagen_status =url_plus; 
                    texto="Agregar zona a la campaña";         
                }
    ...
    $.get(url , {"idcamp" : idcamp}).done(function(data){
        ...
        for (var b = 0; b < data.length; b++) {
            ...
            if ( data[b].nombre != "" ){
                ...
                llenaelementoHTML("#camp_name_lb" , "+"  );
            }


            if (data[b].descripcion != "") {
                llenaelementoHTML("#camp_descripcion_lb" , data[b].descripcion );
            }else{
                llenaelementoHTML("#camp_descripcion_lb" , "+" );
            }
...
function update_name(){
    ...
    $("#camp_name_input").keydown(function(e){
         var code= e.keyCode;               
         if (code == 13){    
...
function update_objetivo(){
    ...
    $("#camp_descripcion_input").keydown(function(e){
         var code= e.keyCode;               
         if (code==13){    
...
function updateall(){
    ...
    $.post(urlupdate ,  $("#form_update_camp").serialize() ).done(function(data){
        ...
        llenaelementoHTML("#repo_update" ,  "Los datos de la campaña se han actualizado");
    }).fail(function(){
        alert("eroor");
    });
